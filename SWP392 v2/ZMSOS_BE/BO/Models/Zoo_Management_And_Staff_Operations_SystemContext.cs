...
public partial class Zoo_Management_And_Staff_Operations_SystemContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AbsentTi__3213E83F77192CC3");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.AbsentTimes)
                ...
                .HasConstraintName("FK__AbsentTim__accou__06CD04F7");

            entity.HasOne(d => d.Status).WithMany(p => p.AbsentTimes)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__AbsentTim__statu__07C12930");
        });

        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3213E83F5AEAE75A");
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Accounts)
                ...
                .HasConstraintName("FK__Account__role_id__08B54D69");

            entity.HasOne(d => d.Status).WithMany(p => p.Accounts)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Account__status___09A971A2");
        });

        modelBuilder.Entity<Animal>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Animal__3213E83FCFE5895F");
            ...
            entity.HasOne(d => d.AnimalType).WithMany(p => p.Animals)
                ...
                .HasConstraintName("FK__Animal__animal_t__0A9D95DB");

            entity.HasOne(d => d.Status).WithMany(p => p.Animals)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Animal__status_i__0B91BA14");
        });

        modelBuilder.Entity<AnimalAssign>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AnimalAs__3213E83FB5D5A4E7");
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.AnimalAssigns)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__AnimalAss__statu__0D7A0286");

            entity.HasOne(d => d.Task).WithMany(p => p.AnimalAssigns)
                .HasForeignKey(d => d.TaskId)
                .HasConstraintName("FK__AnimalAss__task___0E6E26BF");
        });

        modelBuilder.Entity<AnimalCage>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AnimalCa__3213E83F933F96DB");
            ...
            entity.HasOne(d => d.Animal).WithMany(p => p.AnimalCages)
                ...
                .HasConstraintName("FK__AnimalCag__anima__0F624AF8");

            entity.HasOne(d => d.Cage).WithMany(p => p.AnimalCages)
                .HasForeignKey(d => d.CageId)
                .HasConstraintName("FK__AnimalCag__cage___10566F31");

            entity.HasOne(d => d.Status).WithMany(p => p.AnimalCages)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__AnimalCag__statu__114A936A");
        });

        modelBuilder.Entity<AnimalImage>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AnimalIm__3213E83FE3FF7B63");
            ...
            entity.HasOne(d => d.Animal).WithMany(p => p.AnimalImages)
                .HasForeignKey(d => d.AnimalId)
                .HasConstraintName("FK__AnimalIma__anima__123EB7A3");
        });

        modelBuilder.Entity<AnimalIncidentHistory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AnimalIn__3213E83F9ABA121D");
            ...
            entity.HasOne(d => d.Animal).WithMany(p => p.AnimalIncidentHistories)
                .HasForeignKey(d => d.AnimalId)
                .HasConstraintName("FK__AnimalInc__anima__1332DBDC");

            entity.HasOne(d => d.Status).WithMany(p => p.AnimalIncidentHistories)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__AnimalInc__statu__14270015");
        });

        modelBuilder.Entity<AnimalType>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AnimalTy__3213E83F0DD2BDD3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AnimalUp__3213E83F68C19604");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.AnimalUpdateHistories)
                .HasForeignKey(d => d.AccountId)
                .HasConstraintName("FK__AnimalUpd__accou__151B244E");

            entity.HasOne(d => d.Animal).WithMany(p => p.AnimalUpdateHistories)
                .HasForeignKey(d => d.AnimalId)
                .HasConstraintName("FK__AnimalUpd__anima__160F4887");
        });

        modelBuilder.Entity<Application>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Applicat__3213E83FB91EA898");
            ...
            entity.HasOne(d => d.ApplicationType).WithMany(p => p.Applications)
                ...
                .HasConstraintName("FK__Applicati__appli__17036CC0");

            entity.HasOne(d => d.Reciever).WithMany(p => p.ApplicationRecievers)
                .HasForeignKey(d => d.RecieverId)
                .HasConstraintName("FK__Applicati__recie__17F790F9");

            entity.HasOne(d => d.Sender).WithMany(p => p.ApplicationSenders)
                .HasForeignKey(d => d.SenderId)
                .HasConstraintName("FK__Applicati__sende__18EBB532");

            entity.HasOne(d => d.Status).WithMany(p => p.Applications)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Applicati__statu__19DFD96B");
        });

        modelBuilder.Entity<ApplicationType>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Applicat__3213E83F2DC5C0B5");
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.ApplicationTypes)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Applicati__statu__1AD3FDA4");
        });

        modelBuilder.Entity<Cage>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Cage__3213E83F26D2ADC5");
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.Cages)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Cage__status_id__1BC821DD");

            entity.HasOne(d => d.ZooArea).WithMany(p => p.Cages)
                .HasForeignKey(d => d.ZooAreaId)
                .HasConstraintName("FK__Cage__zoo_area_i__1CBC4616");
        });

        modelBuilder.Entity<CageUpdateHistory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__CageUpda__3213E83F940B8B4D");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.CageUpdateHistories)
                .HasForeignKey(d => d.AccountId)
                .HasConstraintName("FK__CageUpdat__accou__1EA48E88");

            entity.HasOne(d => d.Cage).WithMany(p => p.CageUpdateHistories)
                .HasForeignKey(d => d.CageId)
                .HasConstraintName("FK__CageUpdat__cage___1F98B2C1");

            entity.HasOne(d => d.Status).WithMany(p => p.CageUpdateHistories)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__CageUpdat__statu__208CD6FA");
        });

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Category__3213E83F196D2BD1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Evaluati__3213E83F125313AF");
            ...
            entity.HasOne(d => d.Leader).WithMany(p => p.Evaluations)
                ...
                .HasConstraintName("FK__Evaluatio__leade__2180FB33");

            entity.HasOne(d => d.Member).WithMany(p => p.Evaluations)
                .HasForeignKey(d => d.MemberId)
                .HasConstraintName("FK__Evaluatio__membe__22751F6C");

            entity.HasOne(d => d.Status).WithMany(p => p.Evaluations)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Evaluatio__statu__236943A5");
        });

        modelBuilder.Entity<Flock>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Flock__3213E83FC32F4985");
            ...
            entity.HasOne(d => d.Animal).WithMany(p => p.Flocks)
                .HasForeignKey(d => d.AnimalId)
                .HasConstraintName("FK__Flock__animal_id__245D67DE");

            entity.HasOne(d => d.Status).WithMany(p => p.Flocks)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Flock__status_id__25518C17");
        });

        modelBuilder.Entity<IncompatibleAnimalType>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Incompat__3213E83FB19D0512");
            ...
            entity.HasOne(d => d.AnimalTypeId1Navigation).WithMany(p => p.IncompatibleAnimalTypeAnimalTypeId1Navigations)
                ...
                .HasConstraintName("FK__Incompati__anima__2645B050");
            ...
            entity.HasOne(d => d.AnimalTypeId2Navigation).WithMany(p => p.IncompatibleAnimalTypeAnimalTypeId2Navigations)
                ...
                .HasConstraintName("FK__Incompati__anima__2739D489");

            entity.HasOne(d => d.Status).WithMany(p => p.IncompatibleAnimalTypes)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Incompati__statu__282DF8C2");
        });

        modelBuilder.Entity<Individual>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Individu__3213E83FE2F19B5D");
            ...
            entity.HasOne(d => d.Animal).WithMany(p => p.Individuals)
                .HasForeignKey(d => d.AnimalId)
                .HasConstraintName("FK__Individua__anima__29221CFB");

            entity.HasOne(d => d.Status).WithMany(p => p.Individuals)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Individua__statu__2A164134");
        });

        modelBuilder.Entity<LeaderAssign>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__LeaderAs__3213E83FB34B646A");
            ...
            entity.HasOne(d => d.Leader).WithMany(p => p.LeaderAssigns)
                .HasForeignKey(d => d.LeaderId)
                .HasConstraintName("FK__LeaderAss__leade__2B0A656D");

            entity.HasOne(d => d.Status).WithMany(p => p.LeaderAssigns)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__LeaderAss__statu__2BFE89A6");

            entity.HasOne(d => d.Team).WithMany(p => p.LeaderAssigns)
                .HasForeignKey(d => d.TeamId)
                .HasConstraintName("FK__LeaderAss__team___2CF2ADDF");
        });

        modelBuilder.Entity<MemberAssign>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__MemberAs__3213E83FB73BC87F");
            ...
            entity.HasOne(d => d.Member).WithMany(p => p.MemberAssigns)
                .HasForeignKey(d => d.MemberId)
                .HasConstraintName("FK__MemberAss__membe__2DE6D218");

            entity.HasOne(d => d.Status).WithMany(p => p.MemberAssigns)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__MemberAss__statu__2EDAF651");

            entity.HasOne(d => d.Team).WithMany(p => p.MemberAssigns)
                .HasForeignKey(d => d.TeamId)
                .HasConstraintName("FK__MemberAss__team___2FCF1A8A");
        });

        modelBuilder.Entity<News>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__News__3213E83F66F4E7AD");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.News)
                .HasForeignKey(d => d.AccountId)
                .HasConstraintName("FK__News__account_id__30C33EC3");

            entity.HasOne(d => d.Status).WithMany(p => p.News)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__News__status_id__31B762FC");
        });

        modelBuilder.Entity<Notification>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Notifica__3213E83F0FB151E6");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.Notifications)
                .HasForeignKey(d => d.AccountId)
                .HasConstraintName("FK__Notificat__accou__32AB8735");

            entity.HasOne(d => d.Status).WithMany(p => p.Notifications)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Notificat__statu__339FAB6E");
        });

        modelBuilder.Entity<Report>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Report__3213E83F43AFEFE5");
            ...
            entity.HasOne(d => d.Receiver).WithMany(p => p.ReportReceivers)
                ...
                .HasConstraintName("FK__Report__receiver__3493CFA7");

            entity.HasOne(d => d.Sender).WithMany(p => p.ReportSenders)
                .HasForeignKey(d => d.SenderId)
                .HasConstraintName("FK__Report__sender_i__3587F3E0");

            entity.HasOne(d => d.Status).WithMany(p => p.Reports)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Report__status_i__367C1819");
        });

        modelBuilder.Entity<ReportAttachment>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ReportAt__3213E83FE3A9AB2D");
            ...
            entity.HasOne(d => d.Report).WithMany(p => p.ReportAttachments)
                ...
                .HasConstraintName("FK__ReportAtt__repor__37703C52");

            entity.HasOne(d => d.Status).WithMany(p => p.ReportAttachments)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__ReportAtt__statu__3864608B");
        });

        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Role__3213E83F7FA2BD53");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Schedule__3213E83FB8B32061");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.Schedules)
                .HasForeignKey(d => d.AccountId)
                .HasConstraintName("FK__Schedule__accoun__395884C4");

            entity.HasOne(d => d.Status).WithMany(p => p.Schedules)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Schedule__status__3A4CA8FD");
        });

        modelBuilder.Entity<Status>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Status__3213E83FDB47D990");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Statuses)
                ...
                .HasConstraintName("FK__Status__category__1DB06A4F");
        });

        modelBuilder.Entity<Task>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Task__3213E83F5DA57A15");
            ...
            entity.HasOne(d => d.Schedule).WithMany(p => p.Tasks)
                ...
                .HasConstraintName("FK__Task__schedule_i__3B40CD36");

            entity.HasOne(d => d.Status).WithMany(p => p.Tasks)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Task__status_id__3C34F16F");

            entity.HasOne(d => d.TaskType).WithMany(p => p.Tasks)
                .HasForeignKey(d => d.TaskTypeId)
                .HasConstraintName("FK__Task__task_type___3D2915A8");
        });

        modelBuilder.Entity<TaskEstimate>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__TaskEsti__3213E83FB6EBB06B");
            ...
            entity.HasOne(d => d.AnimalType).WithMany(p => p.TaskEstimates)
                .HasForeignKey(d => d.AnimalTypeId)
                .HasConstraintName("FK__TaskEstim__anima__3E1D39E1");

            entity.HasOne(d => d.Status).WithMany(p => p.TaskEstimates)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__TaskEstim__statu__3F115E1A");

            entity.HasOne(d => d.TaskType).WithMany(p => p.TaskEstimates)
                .HasForeignKey(d => d.TaskTypeId)
                .HasConstraintName("FK__TaskEstim__task___40058253");
        });

        modelBuilder.Entity<TaskType>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__TaskType__3213E83FACEB3097");
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.TaskTypes)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__TaskType__status__40F9A68C");
        });

        modelBuilder.Entity<Team>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Team__3213E83F1C19721D");
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.Teams)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__Team__status_id__41EDCAC5");

            entity.HasOne(d => d.ZooArea).WithMany(p => p.Teams)
                .HasForeignKey(d => d.ZooAreaId)
                .HasConstraintName("FK__Team__zoo_area_i__42E1EEFE");
        });

        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3213E83F9E24B4B5");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.Users)
                .HasForeignKey(d => d.AccountId)
                .HasConstraintName("FK__User__account_id__43D61337");
        });

        modelBuilder.Entity<ZooArea>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ZooArea__3213E83FE740EB3D");
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.ZooAreas)
                .HasForeignKey(d => d.StatusId)
                .HasConstraintName("FK__ZooArea__status___44CA3770");
        });
