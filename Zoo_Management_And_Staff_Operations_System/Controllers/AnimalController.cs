...
namespace AnimalAndCageManagement.Controllers
{
    ...
    public class AnimalController : ControllerBase
    {
        ...
        [Authorize(Roles = "Manager,Leader,Staff")]
        [HttpGet("animal/history/{id}")]
        public async Task<IActionResult> GetAnimalHistoryById(int id)
        {
            var result = await service.GetAnimalHistoryById(id);
            StatusResult statusResult = new StatusResult();
            return statusResult.Result(result);
        }
        ...
        [HttpDelete("animal/disable/id/{animalId}")]
        public async Task<IActionResult> DisableAnimal(int animalId)
        {
            var result = await service.DisableAnimal(animalId);
            StatusResult statusResult = new StatusResult();
            return statusResult.Result(result);
        }
        [Authorize(Roles = "Manager")]
